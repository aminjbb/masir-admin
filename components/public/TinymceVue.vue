...
export default {
  ...
  methods: {
    ...
    images_upload_handler: function (blobInfo, success, failure) {
      ...
      axios
        .post(process.env.apiUrl + "image/admin/", data, {
          headers: {
        ...
        .then(function (res) {
          success(process.env.baseUrl + res.data.image);
        })
        .catch(function (err) {
