    ...
    <v-form v-model="valid" ref="addBlog">
      ...
      <v-row justify="center" class="mt-15 pt-10">
        <v-col cols="5">
          ...
          <div class="box-card mr-10 mt-15 py-5 pt-8">
            <v-row justify="end" class="px-8">
              <v-card outlined class="br-10  ml-15" max-height="40" width="194">
                <v-item-group v-model="form.index" active-class="btn2_toggle-plp">
            ...
            <v-row justify="end" class="px-8 mt-6 mb-2">
              <v-card outlined class="br-10  ml-11" max-height="40" width="194">
                <v-item-group v-model="form.follow" active-class="btn2_toggle-plp">
          ...
          <div class="box-card mr-10 mt-15 py-5 pt-8 d-flex justify-space-between px-10 align-center">
            <span>فعال سازی</span>
            <span>
              <v-switch v-model="form.isActive" color="success">
          ...
          <div class="box-card mr-10 py-4 pt-8">
            <div>
              ...
              <div class="mx-12 ml-14 mt-3">
                <v-combobox multiple color="black" v-model="form.keyWord" label="Meta Keyword" class="br-10" filled dense></v-combobox>
              </div>
...
export default {
  ...
  methods: {
    ...
    createBlog() {
      ...
      axios({
        method: 'post',
        url: process.env.apiUrl + 'blog_post/v1/admin/',
        headers: {
          Authorization: "Bearer " + this.$cookies.get("token"),
          "Content-Type": "multipart/form-data",
        },
        data: {
          page_title: this.form.mainTitle,
